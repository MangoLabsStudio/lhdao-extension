...
export const PLUGIN_OPERATIONS: readonly PluginOperationDefinition[] = [
  ...
  operation(
    'verify.product-experience.zktls-start.v2',
    'StartProductZkTlsProof',
    PRODUCT_EXPERIENCE_EXECUTION_DOCUMENT,
    '632321c0660eb06bef95b6a5d9c1a20b81e75077963af4deb219e310a0fe29fc',
    'verify',
  ),
  operation(
    'verify.product-experience.zktls-test-start.v2',
  ...
  operation(
    'read.product-experience.zktls-progress.v2',
  ...
  operation(
    'read.product-experience.integration-status.v1',
